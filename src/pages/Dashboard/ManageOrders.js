...
const ManageOrders = () => {
    ...
    useEffect(() => {
        const url = `https://vast-everglades-91975.herokuapp.com/orders`
        fetch(url, {
            method: 'GET',
            headers: {
    ...
    const makeShipped = (id) => {
        const url = `https://vast-everglades-91975.herokuapp.com/orders/${id}`
        fetch(url, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
    ...
    const deleteParts = (id) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                const url = `https://vast-everglades-91975.herokuapp.com/order/${id}`
                fetch(url, {
                    method: 'DELETE',
                    headers: {
                        'Content-Type': 'application/json',
